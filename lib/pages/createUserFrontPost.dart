    ...
    Widget build(BuildContext context) {
        ...
        try {
            ...
            Navigator.push(
                    context,
                    MaterialPageRoute(
                            builder: (context) => DisplayPictureScreen2(imagePath: path),
            ),
            );
        } catch (e) {
...
class CreateUserFrontPost extends StatelessWidget {
    String imagePath;

    CreateUserFrontPost({Key key, this.imagePath}) : super(key: key);
...
class DisplayPictureScreen2 extends StatelessWidget {
    ...
    const DisplayPictureScreen2({Key key, this.imagePath}) : super(key: key);
