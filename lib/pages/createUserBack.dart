...
class CreateUserBack extends StatefulWidget {
  ...
  @override
  _CreateUserBackState createState() => _CreateUserBackState();

}

class _CreateUserBackState extends State<CreateUserBack> {
  File _imageFile;
  File _imageFile2;
  File _selfi;
  String img64;
...
//    SystemChrome.setPreferredOrientations([DeviceOrientation.portraitDown, DeviceOrientation.portraitUp]);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Registro Back de documento'),
        centerTitle: false,
        elevation: 1.0,
            ...
            children: <Widget>[
              ...
              RaisedButton(
                ...
                onPressed :() async {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>widgetCamaraBack(
                      camerasdescripcion: widget.camerasdescripcion,
                      idOperacion: widget.idOperacion,
                  )));
